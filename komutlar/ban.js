...
exports.run = (client, message, args) => {
  ...
  const embed = new Discord.RichEmbed()
    .setColor(0x00AE86)
    .setTimestamp()
    .setImage('https://cdn.discordapp.com/attachments/525933843224592384/536510134223110155/oX2PpX.png')
    .addField('Eylem:','Ölünüzü Dirinizi Her Gün **Birinizi** Bir Gün **Hepinizi**')
